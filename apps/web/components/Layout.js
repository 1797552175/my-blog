                  ...
                  <Menu as="div" className="relative">
                    ...
                    >
                      <Menu.Items className="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white dark:bg-gray-800 ring-1 ring-black ring-opacity-5 focus:outline-none">
                        <Menu.Item>
                          {({ active }) => (
                            <Link href="/write" className={classNames(active ? 'bg-gray-100 dark:bg-gray-700' : '', 'block px-4 py-2 text-sm text-gray-700 dark:text-gray-200')}>写小说</Link>
                          )}
                        </Menu.Item>
                        <Menu.Item>
                          {({ active }) => (
                            <Link href="/me/posts" className={classNames(active ? 'bg-gray-100 dark:bg-gray-700' : '', 'block px-4 py-2 text-sm text-gray-700 dark:text-gray-200')}>我的小说</Link>
                          )}
                        </Menu.Item>
                        <Menu.Item>
                          {({ active }) => (
              ...
              <div className="pt-4 mt-4 border-t border-gray-200 dark:border-gray-700">
                {user ? (
                  <div className="px-2 space-y-1">
                      <Link href="/write" className="block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-300" onClick={() => setMobileMenuOpen(false)}>写小说</Link>
                      <Link href="/me/posts" className="block px-3 py-2 rounded-md text-base font-medium text-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 dark:text-gray-300" onClick={() => setMobileMenuOpen(false)}>我的小说</Link>
